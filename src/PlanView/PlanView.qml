...
//             readonly property int takeoffButtonIndex:   2
//             readonly property int waypointButtonIndex:  3
//             readonly property int returnButtonIndex:    4
...
Item {
    ...
    readonly property var _layers: [_layerMission]
    ...
    Item {
        ...
        ToolStrip {
            ...
            ToolStripActionList {
                ...
                model: [
                    ...
                    ToolStripAction {
                        id: addWaypointAction
                        text: qsTr("Waypoint")
                        iconSource: "/qmlimages/MapAddMission.svg"
                        enabled: toolStrip._isMissionLayer && _missionController.flyThroughCommandsAllowed
                        visible: toolStrip._isMissionLayer
                        checkable: true
                    },
                    ToolStripAction {
            ...
            function allAddClickBoolsOff() {
                addWaypointAction.checked = false
            }
        ...
        QGCLabel {
            ...
            anchors.horizontalCenter: terrainStatus.horizontalCenter
            anchors.bottomMargin: ScreenTools.defaultFontPixelWidth * 0.5
            font.pointSize: ScreenTools.smallFontPixelSize
            text: qsTr("Powered by %1").arg(_licenseString)
        }
