...
Item {
    ...
    Component {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                QGCLabel {
                    text: qsTr("Mission Start")
                    font.pointSize: ScreenTools.mediumFontPointSize
                }

                QGCLabel {
                    text: qsTr("Initial Altitude")
                    font.pointSize: ScreenTools.smallFontPointSize
                }
                FactTextField {
                    fact: QGroundControl.settingsManager.appSettings.defaultMissionItemAltitude
    ...
    Component {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                FactTextField {
                    fact: missionItem.holdTime
                    Layout.fillWidth: true
                }

                QGCButton {
                    text: qsTr("Delete Waypoint")
                    onClicked: missionItem.remove()
                    anchors.horizontalCenter: parent.horizontalCenter
                }
            }
        }
    ...
    Loader {
        ...
        onLoaded: {
            // Ensure the component is visible after loading
            itemLoader.item.visible = true;
        }
    }
    ...
    Connections {
        ...
        onCurrentMissionItemChanged: {
            // Load appropriate component based on current mission item type
            if (_missionController.currentMissionItem.command === QGroundControl.MAV_CMD_NAV_TAKEOFF) {
                itemLoader.sourceComponent = missionStartComponent;
            } else if (_missionController.currentMissionItem.command === QGroundControl.MAV_CMD_NAV_WAYPOINT) {
                itemLoader.sourceComponent = waypointComponent;
            }
        }
    }
}
