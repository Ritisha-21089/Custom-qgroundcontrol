...
public:
    ...
    QString             brandImageIndoor                (const Vehicle* vehicle) const override { Q_UNUSED(vehicle); return QStringLiteral("/qmlimages/resources/8ol_logo_linear.png");}     ///APM/BrandImage"); }
    QString             brandImageOutdoor               (const Vehicle* vehicle) const override { Q_UNUSED(vehicle); return QStringLiteral("/qmlimages/resources/8ol_logo_linear.png");} ///APM/BrandImage"); }
